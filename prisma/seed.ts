...
async function main() {
  ...
  await prisma.evidence.create({
    data: {
      ...
      uploadedById: tech.id,
      category: "recepcion",
      storagePath: "evidence/seed/recepcion_frontal.jpg",
  ...
  await prisma.evidence.create({
    data: {
      ...
      storagePath: "evidence/seed/tablero_testigos.jpg",
  ...
  await prisma.evidence.create({
    data: {
      ...
      uploadedById: tech.id,
      category: "escaner",
      storagePath: "evidence/seed/scan_dtc.jpg",
  ...
  await prisma.evidence.create({
    data: {
      ...
      storagePath: "evidence/seed/autotuner_conectado.jpg",
